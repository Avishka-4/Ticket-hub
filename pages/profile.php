...
// If this is a demo session, do not query the DB - show a minimal readonly profile
$isDemo = isset($_SESSION['is_demo']) && $_SESSION['is_demo'];
if ($isDemo) {
    // Provide a minimal $user array so the template can render consistently
    $user = [
        'first_name' => 'Demo',
        'last_name' => 'User',
        'email' => $_SESSION['email'] ?? 'demo@tickethub.com',
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-6xl mx-auto">
            ...
            <!-- Tabs: show full UI for normal users; simplified readonly view for demo users -->
            <?php if ($isDemo): ?>
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info mt-3">
                            This is a demo account. Editing and account actions are disabled for demo users.
                        </div>
                    </div>
                </div>
            <?php else: ?>
                <!-- Full tabs and editable profile for non-demo users -->
